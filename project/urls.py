...
urlpatterns = [
    ...
    path('pmp-project-update/<int:pk>/', views.PmpProjectUpdate.as_view(), name='pmp_project_update'),
    path('ministry-project-update/<int:pk>/', views.MinistryProjectUpdate.as_view(), name='ministry_project_update'),
    ...
    path('ministry-reports', views.MinistryReports.as_view(), name='ministry_reports'),
    path('governor-reports', views.GovernorReports.as_view(), name='governor_reports'),
